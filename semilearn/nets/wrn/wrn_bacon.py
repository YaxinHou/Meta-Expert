...
class WideResNet(nn.Module):
    def __init__(self, first_stride, num_classes, depth=28, widen_factor=2, drop_rate=0.0, **kwargs):
        ...
        self.projection = nn.Linear(channels[3], 32)
    ...
    def forward(self, x, only_fc=False, only_feat=False, **kwargs):
        ...
        result_dict = {'logits': output, 'aux_logits': aux_out, 'pro_out': pro_out, 'feat': out}
...
def wrn_28_2_bacon(pretrained=False, pretrained_path=None, **kwargs):
...
def wrn_28_8_bacon(pretrained=False, pretrained_path=None, **kwargs):
